...
@brief
    Aisiom main activity
    Additional Classes by (c) Qualcolmm Austria Research
...
/** The main Activity for the Aisiom App */
public class AisiomLaunchAR extends Activity
{
    ...
    private static final String NATIVE_LIB_SAMPLE = "AisiomLaunchAR";
    ...
    // Our renderer:
    private AisiomRendererAR mRenderer;
    ...
    boolean mIsPlantsAisiomDataSet  = false;
    ...
    {
        private final WeakReference<AisiomLaunchAR> mImageTargets;


        LoadingDialogHandler(AisiomLaunchAR imageTargets)
        {
            mImageTargets = new WeakReference<AisiomLaunchAR>(
                    imageTargets);
        }
        ...
        {
            AisiomLaunchAR imageTargets = mImageTargets.get();
    ...
    private class InitQCARTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(AisiomLaunchAR.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                DebugLogAR.LOGD("InitQCARTask::onPostExecute: QCAR " +
            ...
            else
            {
                ...
                // Log error:
                DebugLogAR.LOGE("InitQCARTask::onPostExecute: " + logMessage +
                                " Exiting.");
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            DebugLogAR.LOGD("LoadTrackerTask::onPostExecute: execution " +
                        (result ? "successful" : "failed"));

            if (result)
            {
                // The AisiomPlants data set is now active:
                mIsPlantsAisiomDataSet = true;
    ...
    {
        DebugLogAR.LOGD("ImageTargets::onCreate");
    ...
    private void loadTextures()
    {
    	...
    	//add banana and brass texture @bright onapito
        mTextures.add(Texture.loadTextureFromApk("TextureBanana.jpg",
                getAssets()));
   ...
   /** Called when the activity will start interacting with the user.*/
    ...
    {
        DebugLogAR.LOGD("ImageTargets::onResume");
        super.onResume();
    ...
    private void updateActivityOrientation()
    {
        ...
        DebugLogAR.LOGI("Activity is in "
    ...
    public void updateRenderView()
    {
        ...
        if (currentScreenRotation != mLastScreenRotation)
        {
            ...
            {
                DebugLogAR.LOGD("ImageTargets::updateRenderView");
    ...
    {
        DebugLogAR.LOGD("ImageTargets::onConfigurationChanged");
    ...
    {
        DebugLogAR.LOGD("ImageTargets::onPause");
        super.onPause();
    ...
    {
        DebugLogAR.LOGD("ImageTargets::onDestroy");
        super.onDestroy();
    ...
    private synchronized void updateApplicationStatus(int appStatus)
    {
        ...
        switch (mAppStatus)
        {
            ...
            case APPSTATUS_INIT_QCAR:
                ...
                {
                    DebugLogAR.LOGE("Initializing QCAR SDK failed");
                }
                break;
            ...
            case APPSTATUS_LOAD_TRACKER:
                ...
                {
                    DebugLogAR.LOGE("Loading tracking data set failed");
                }
                break;
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer = new AisiomRendererAR();
        mRenderer.mActivity = this;
        mGlView.setRenderer(mRenderer);

        LayoutInflater inflater = LayoutInflater.from(this);
        mUILayout = (RelativeLayout) inflater.inflate(R.layout.cam_overlay,
                null, false);
        ...
        mLoadingDialogContainer = mUILayout.findViewById(R.id.loading_item);
    ...
    public static boolean loadLibrary(String nLibName)
    {
        try
        {
            ...
            DebugLogAR.LOGI("Native library lib" + nLibName + ".so loaded");
            return true;
        }
        catch (UnsatisfiedLinkError ulee)
        {
            DebugLogAR.LOGE("The library lib" + nLibName +
                ...
                new DialogInterface.OnClickListener()
                {
                    public void onClick(DialogInterface dialog, int item)
                    {
                        ...
                        else if (item == itemSwitchDatasetIndex)
                        {
                            ...
                            switchDatasetAsap();
                            mIsPlantsAisiomDataSet = !mIsPlantsAisiomDataSet;
