...
Support Class for setting up and configuring OpenGL Surface view
...
public class QCARSampleGLView extends GLSurfaceView
{
    ...
    public void init(int flags, boolean translucent, int depth, int stencil)
    {
        ...
        DebugLogAR.LOGI("Using OpenGL ES " + (mUseOpenGLES2 ? "2.0" : "1.x"));
        DebugLogAR.LOGI("Using " + (translucent ? "translucent" : "opaque") +
        ...
        GLSurfaceView.EGLContextFactory
    {
            ...
            EGLConfig eglConfig)
        {
            ...
            if (mUseOpenGLES2)
            {
                DebugLogAR.LOGI("Creating OpenGL ES 2.0 context");
            ...
            {
                DebugLogAR.LOGI("Creating OpenGL ES 1.x context");
                checkEglError("Before eglCreateContext", egl);
    ...
    private static void checkEglError(String prompt, EGL10 egl)
    {
        ...
        {
            DebugLogAR.LOGE(String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
